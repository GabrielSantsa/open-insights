    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="flex flex-col gap-6">
        <div className="w-full flex flex-col gap-6">
          ...
          {/* Estrutura de Reporte - Agora abaixo do card principal de perfil */}
            ...
            <CardContent className="pt-6">
              <div className="space-y-6">
                ...
                {!employee.gestor && !employee.coordenador && (
                  <p className="text-xs text-muted-foreground italic py-2">Nenhuma estrutura de reporte atribuída.</p>
                )}
              </div>
            </CardContent>
          </Card>
            ...
            <TabsContent value="demandas" className="mt-6 space-y-6">
              {(() => {
                const { data: employeeTasks, isLoading: loadingTasks } = useQuery({
                  queryKey: ["employee-tasks", employee.user_id],
                  queryFn: async () => {
                ...
                const counts = {
                  ...
                  atrasadas: employeeTasks?.filter(t => t.due_date && new Date(t.due_date) < new Date() && t.status !== 'concluida').length || 0
                };
